...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 leak /home/kuenzel/Dokumente/Python/SCNv2/mech/leak.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kuenzel/Dokumente/Python/SCNv2/mech/leak.mod";
static const char* nmodl_file_text = 
