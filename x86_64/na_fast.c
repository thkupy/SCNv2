...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na_fast /home/kuenzel/Dokumente/Python/SCNv2/mech/na_fast.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kuenzel/Dokumente/Python/SCNv2/mech/na_fast.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "    SUFFIX na_fast\n"
